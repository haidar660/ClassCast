...
SUMMARY_PATH = Path("test_output/experiment_summary.json")
...
def save_summary(log: List[Dict[str, str]]) -> None:
    """Persist experiment results so the UI or other tools can read them."""
    SUMMARY_PATH.parent.mkdir(parents=True, exist_ok=True)
    SUMMARY_PATH.write_text(json.dumps(log, indent=2), encoding="utf-8")
